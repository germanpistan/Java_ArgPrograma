...
import ventas.DescuentoACarritoVacioException;
...
public class Main {
    public static void main(String[] args) {
        ...
        List<ItemCarrito> items = new ArrayList<>();   //linea de codigo para instanciar la list como array list
        ...
        for (int i = 1; i < lineas.length; i++) {
            ...
            items.add(itemI);  //metodo para agregar a items el item carrito itemI
        }
        try {
            System.out.println("Precio final del carrito= " + carro.precio(true, 100.0f));
        } catch (DescuentoACarritoVacioException e) {
